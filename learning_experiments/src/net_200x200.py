...
class Operator(chainer.Chain):
    ...
    def __init__(self, n_latent=None, embed_size=None):
...
class Conv_Siam_VAE(chainer.Chain):
    ...
    def encode(self, x_b0, x_b1):
        ...
        conv_b0_0_encoded = F.leaky_relu(self.encoder_conv_b0_0(pool_b0_00_encoded)) # (100, 100)
        ...
        # conv_b1_00_encoded = F.leaky_relu(self.encoder_conv_b1_00(x_b1)) # (200, 200)
        # pool_b1_00_encoded = F.max_pooling_2d(conv_b1_00_encoded, ksize=2) # (100, 100)
        # conv_b1_0_encoded = F.leaky_relu(self.encoder_conv_b1_0(pool_b1_00_encoded)) # (100, 100)
        # pool_b1_0_encoded = F.max_pooling_2d(conv_b1_0_encoded, ksize=2) # (50, 50)
        # conv_b1_1_encoded = F.leaky_relu(self.encoder_conv_b1_1(pool_b1_0_encoded)) # (50, 50)
        # pool_b1_1_encoded = F.max_pooling_2d(conv_b1_1_encoded, ksize=2) # (25, 25)
        # conv_b1_2_encoded = F.leaky_relu(self.encoder_conv_b1_2(pool_b1_1_encoded)) # (22, 22)
        # pool_b1_2_encoded = F.max_pooling_2d(conv_b1_2_encoded, ksize=2) # (11, 11)
        # conv_b1_3_encoded = F.leaky_relu(self.encoder_conv_b1_3(pool_b1_2_encoded)) # (8, 8)
        ...
        conv_b1_00_encoded = F.leaky_relu(self.encoder_conv_b0_00(x_b1)) # (200, 200)
        pool_b1_00_encoded = F.max_pooling_2d(conv_b1_00_encoded, ksize=2) # (100, 100)
        conv_b1_0_encoded = F.leaky_relu(self.encoder_conv_b0_0(pool_b1_00_encoded)) # (100, 100)
        pool_b1_0_encoded = F.max_pooling_2d(conv_b1_0_encoded, ksize=2) # (50, 50)
    ...
    def decode(self, z_b0, z_b1, latent, latent_flipped, sigmoid=True):
        ...
        deconv_b0_4_decoded = F.leaky_relu(self.decoder_conv_b0_4(up_b0_3_decoded)) # (100, 100)
        ...
        # deconv_b1_4_decoded = F.leaky_relu(self.decoder_conv_b1_4(up_b1_3_decoded)) # (100, 100)
        ...
        up_b1_0_decoded = F.unpooling_2d(deconv_b1_0_decoded, ksize=2, cover_all=False) # (16, 16)
        deconv_b1_1_decoded = F.leaky_relu(self.decoder_conv_b0_1(up_b1_0_decoded)) # (14, 14)
        up_b1_1_decoded = F.unpooling_2d(deconv_b1_1_decoded, ksize=2, cover_all=False) # (28, 28)
        deconv_b1_2_decoded = F.leaky_relu(self.decoder_conv_b0_2(up_b1_1_decoded)) # (25, 25)
        up_b1_2_decoded = F.unpooling_2d(deconv_b1_2_decoded, ksize=2, cover_all=False) # (50, 50)
        deconv_b1_3_decoded = F.leaky_relu(self.decoder_conv_b0_3(up_b1_2_decoded)) # (50, 50)
        up_b1_3_decoded = F.unpooling_2d(deconv_b1_3_decoded, ksize=2, cover_all=False) # (100, 100)
        deconv_b1_4_decoded = F.leaky_relu(self.decoder_conv_b0_4(up_b1_3_decoded)) # (100, 100)
        up_b1_4_decoded = F.unpooling_2d(deconv_b1_4_decoded, ksize=2, cover_all=False) # (200, 200)
    ...
    def get_loss_func(self, k=1):
        ...
        def lf(x):
            ...
            # art_ln_var = cupy.zeros((batchsize, len(self.groups_len))).astype(cupy.float32)
            
            # print(latent_stacked)
            # print(art_ln_var)
            # print(latent_stacked.dtype)
            # print(art_ln_var.dtype)
            # print(latent_stacked.shape)
            # print(art_ln_var.shape)
            # print(mu_b1.shape)
            # print(ln_var_b1.shape)
